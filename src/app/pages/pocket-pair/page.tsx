  ...
  return (
    <div>
      ...
      <JobCards
          ...
          bgMain="bg-[url('/assets/pocketpairbg.webp')]"
          ...
          exampleImages={[
            '/assets/jobCards/jobImages/pocketpair1.jpg',
            '/assets/jobCards/jobImages/pocketpair2.jpg',
            '/assets/jobCards/jobImages/pocketpair3.jpg',
            '/assets/jobCards/jobImages/pocketpair4.jpg',
          ]} />
     </div>
